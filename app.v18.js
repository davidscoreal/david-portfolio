(() => {
  ...
  function App() {
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "lt-marquee-overlay", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("span", { className: "lt-marquee-label" }, "Blockchain Contract Auditing")))))), /* @__PURE__ */ React.createElement("section", { className: "lt-block" }, /* @__PURE__ */ React.createElement("h2", { className: "lt-section-title" }, "PRICING"), /* @__PURE__ */ React.createElement(PricingDial, null), /* @__PURE__ */ React.createElement("button", { type: "button", className: "lt-pricing-cta-bar", onClick: openLead }, "Solicitar info →")), /* @__PURE__ */ React.createElement("section", { className: "lt-block" }, /* @__PURE__ */ React.createElement("h2", { className: "lt-section-title" }, "TRUSTED BY LEADING ORGANIZATIONS"), /* @__PURE__ */ React.createElement("div", { className: "lt-clients" }, /* @__PURE__ */ React.createElement("img", { src: "assets/clients/logos.jpg", alt: "Trusted by leading organizations", draggable: "false" }))), /* @__PURE__ */ React.createElement("section", { className: "lt-block" }, /* @__PURE__ */ React.createElement("h2", { className: "lt-section-title" }, "COMMUNITIES"), /* @__PURE__ */ React.createElement("div", { className: "lt-communities", "aria-label": "Communities" }, COMMUNITIES.map(
